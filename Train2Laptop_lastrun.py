...
expName = 'Train2Laptop'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\lille\\NewOneDrive\\OneDrive\\Emilie\\MasterThesisProject\\Train2Laptop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ExcelOutputTrainStep2.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        trial_1 = data.Routine(
            name='trial_1',
            components=[img, spacebar, seafoam, pink, lime_green, orange, blue, yellow, purple, cyan, red, green, Instructions, RBGInfo, R, G, B, counter_Text, total_count],
        )
        ...
        confidence = data.Routine(
            name='confidence',
            components=[slider, text_9, mouse_2, button2, text_answer, seafoam_3, pink_3, lime_green_3, orange_3, blue_3, yellow_3, purple_3, cyan_3, red_3, green_3],
        )
        ...
        confirm = data.Routine(
            name='confirm',
            components=[Button3, correctAnswer, wrongAnswer, corrColor_2, seafoam_2, pink_2, lime_green_2, orange_2, blue_2, yellow_2, purple_2, cyan_2, red_2, green_2, RBGInfo_2, R_2, G_2, B_2, key_resp],
        )
