...
expName = 'ExpDemo'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\emilie\\OneDrive\\Emilie\\MasterThesisProject\\ExpDemo_lastrun.py',
