...
expName = 'Train3Laptop'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\emilie\\OneDrive\\Emilie\\MasterThesisProject\\Train3Laptop_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    img_Var1 = ''
    img_Var1Container = []
    # Set experiment start values for variable component Rvar1
    Rvar1 = ''
    Rvar1Container = []
    # Set experiment start values for variable component Gvar1
    Gvar1 = ''
    Gvar1Container = []
    # Set experiment start values for variable component Bvar1
    Bvar1 = ''
    Bvar1Container = []
    ...
    brown = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,490),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    brown.buttonClock = core.Clock()
    teal = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,430),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    teal.buttonClock = core.Clock()
    bordeaux = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,370),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    bordeaux.buttonClock = core.Clock()
    grey = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,310),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    grey.buttonClock = core.Clock()
    seafoam = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,250),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    seafoam.buttonClock = core.Clock()
    pink = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,190),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    pink.buttonClock = core.Clock()
    lime_green = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,130),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    lime_green.buttonClock = core.Clock()
    orange = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,70),units='pix',
        letterHeight=30.0,
        size=(250,50), 
        ori=0.0
        ,borderWidth=20.0,
    ...
    B = visual.TextStim(win=win, name='B',
        ...
        languageStyle='LTR',
        depth=-22.0);
    counter_Text = visual.TextStim(win=win, name='counter_Text',
        text='',
        font='Arial',
        units='pix', pos=(-520, -400), draggable=False, height=72.0, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=1.0, 
        languageStyle='LTR',
        depth=-23.0);
    total_count = visual.TextStim(win=win, name='total_count',
        text='      / 38',
        font='Arial',
        units='pix', pos=(-475, -400), draggable=False, height=72.0, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=1.0, 
        languageStyle='LTR',
        depth=-24.0);
    ...
    brown_3.buttonClock = core.Clock()
    teal_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,430),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    teal_3.buttonClock = core.Clock()
    bordeaux_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,370),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    bordeaux_3.buttonClock = core.Clock()
    grey_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,310),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    grey_3.buttonClock = core.Clock()
    seafoam_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,250),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    seafoam_3.buttonClock = core.Clock()
    pink_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,190),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    pink_3.buttonClock = core.Clock()
    lime_green_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,130),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    lime_green_3.buttonClock = core.Clock()
    orange_3 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,70),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    orange_3.buttonClock = core.Clock()
    ...
    brown_2.buttonClock = core.Clock()
    teal_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,430),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    teal_2.buttonClock = core.Clock()
    bordeaux_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,370),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    bordeaux_2.buttonClock = core.Clock()
    grey_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,310),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    grey_2.buttonClock = core.Clock()
    seafoam_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,250),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    seafoam_2.buttonClock = core.Clock()
    pink_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,190),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    pink_2.buttonClock = core.Clock()
    lime_green_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,130),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    lime_green_2.buttonClock = core.Clock()
    orange_2 = visual.ButtonStim(win, 
        text='', font='Arvo',
        pos=(750,70),units='pix',
        letterHeight=30.0,
        size=(250,50), 
    ...
    orange_2.buttonClock = core.Clock()
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ExcelOutputTrainStep3.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if event.getKeys(['p']):
                BreakIt = True
            Rvar1 = corrR_Var  # Set frame start values for Rvar1
            Rvar1Container.append(Rvar1)  # Save frame values
            Gvar1 = ""  # Set frame start values for Gvar1
            Gvar1Container.append(Gvar1)  # Save frame values
            Bvar1 = ""  # Set frame start values for Bvar1
            Bvar1Container.append(Bvar1)  # Save frame values
        ...
        trial_1 = data.Routine(
            name='trial_1',
            components=[img, spacebar, brown, teal, bordeaux, grey, seafoam, pink, lime_green, orange, blue, yellow, purple, cyan, red, green, Instructions, RBGInfo, R, G, B, counter_Text, total_count],
        )
        ...
        _spacebar_allKeys = []
        brown.setText('Brown')
        # reset brown to account for continued clicks & clear times on/off
        brown.reset()
        teal.setText('Teal')
        # reset teal to account for continued clicks & clear times on/off
        teal.reset()
        bordeaux.setText('Bordeaux')
        # reset bordeaux to account for continued clicks & clear times on/off
        bordeaux.reset()
        grey.setText('Grey')
        # reset grey to account for continued clicks & clear times on/off
        grey.reset()
        seafoam.setText('Seafoam')
        # reset seafoam to account for continued clicks & clear times on/off
        seafoam.reset()
        pink.setText('Pink')
        # reset pink to account for continued clicks & clear times on/off
        pink.reset()
        lime_green.setText('Lime-green')
        # reset lime_green to account for continued clicks & clear times on/off
        lime_green.reset()
        orange.setText('Orange')
        # reset orange to account for continued clicks & clear times on/off
        orange.reset()
        blue.setText('Blue')
        ...
        counter_Text.setText(trial_counter)
        ...
        while continueRoutine:
            ...
            # if brown is starting this frame...
            if brown.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                brown.frameNStart = frameN  # exact frame index
                brown.tStart = t  # local t and not account for scr refresh
                brown.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(brown, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'brown.started')
                # update status
                brown.status = STARTED
                win.callOnFlip(brown.buttonClock.reset)
                brown.setAutoDraw(True)
            
            # if brown is active this frame...
            if brown.status == STARTED:
                # update params
                pass
                # check whether brown has been pressed
                if brown.isClicked:
                    if not brown.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        brown.timesOn.append(routineTimer.getTime())
                        brown.timesOff.append(routineTimer.getTime())
                    elif len(brown.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        brown.timesOff[-1] = routineTimer.getTime()
                    if not brown.wasClicked:
                        # end routine when brown is clicked
                        continueRoutine = False
                    if not brown.wasClicked:
                        # run callback code when brown is clicked
                        answer = "Brown"
                        colorList.append(answer)
            # take note of whether brown was clicked, so that next frame we know if clicks are new
            brown.wasClicked = brown.isClicked and brown.status == STARTED
            # *teal* updates
            
            # if teal is starting this frame...
            if teal.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                teal.frameNStart = frameN  # exact frame index
                teal.tStart = t  # local t and not account for scr refresh
                teal.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(teal, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'teal.started')
                # update status
                teal.status = STARTED
                win.callOnFlip(teal.buttonClock.reset)
                teal.setAutoDraw(True)
            
            # if teal is active this frame...
            if teal.status == STARTED:
                # update params
                pass
                # check whether teal has been pressed
                if teal.isClicked:
                    if not teal.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        teal.timesOn.append(routineTimer.getTime())
                        teal.timesOff.append(routineTimer.getTime())
                    elif len(teal.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        teal.timesOff[-1] = routineTimer.getTime()
                    if not teal.wasClicked:
                        # end routine when teal is clicked
                        continueRoutine = False
                    if not teal.wasClicked:
                        # run callback code when teal is clicked
                        answer = "Teal"
                        colorList.append(answer)
            # take note of whether teal was clicked, so that next frame we know if clicks are new
            teal.wasClicked = teal.isClicked and teal.status == STARTED
            # *bordeaux* updates
            
            # if bordeaux is starting this frame...
            if bordeaux.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                bordeaux.frameNStart = frameN  # exact frame index
                bordeaux.tStart = t  # local t and not account for scr refresh
                bordeaux.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(bordeaux, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'bordeaux.started')
                # update status
                bordeaux.status = STARTED
                win.callOnFlip(bordeaux.buttonClock.reset)
                bordeaux.setAutoDraw(True)
            
            # if bordeaux is active this frame...
            if bordeaux.status == STARTED:
                # update params
                pass
                # check whether bordeaux has been pressed
                if bordeaux.isClicked:
                    if not bordeaux.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        bordeaux.timesOn.append(routineTimer.getTime())
                        bordeaux.timesOff.append(routineTimer.getTime())
                    elif len(bordeaux.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        bordeaux.timesOff[-1] = routineTimer.getTime()
                    if not bordeaux.wasClicked:
                        # end routine when bordeaux is clicked
                        continueRoutine = False
                    if not bordeaux.wasClicked:
                        # run callback code when bordeaux is clicked
                        answer = "Bordeaux"
                        colorList.append(answer)
            # take note of whether bordeaux was clicked, so that next frame we know if clicks are new
            bordeaux.wasClicked = bordeaux.isClicked and bordeaux.status == STARTED
            # *grey* updates
            
            # if grey is starting this frame...
            if grey.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                grey.frameNStart = frameN  # exact frame index
                grey.tStart = t  # local t and not account for scr refresh
                grey.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(grey, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'grey.started')
                # update status
                grey.status = STARTED
                win.callOnFlip(grey.buttonClock.reset)
                grey.setAutoDraw(True)
            
            # if grey is active this frame...
            if grey.status == STARTED:
                # update params
                pass
                # check whether grey has been pressed
                if grey.isClicked:
                    if not grey.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        grey.timesOn.append(routineTimer.getTime())
                        grey.timesOff.append(routineTimer.getTime())
                    elif len(grey.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        grey.timesOff[-1] = routineTimer.getTime()
                    if not grey.wasClicked:
                        # end routine when grey is clicked
                        continueRoutine = False
                    if not grey.wasClicked:
                        # run callback code when grey is clicked
                        answer = "Grey"
                        colorList.append(answer)
            # take note of whether grey was clicked, so that next frame we know if clicks are new
            grey.wasClicked = grey.isClicked and grey.status == STARTED
            # *seafoam* updates
            
            # if seafoam is starting this frame...
            if seafoam.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                seafoam.frameNStart = frameN  # exact frame index
                seafoam.tStart = t  # local t and not account for scr refresh
                seafoam.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(seafoam, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'seafoam.started')
                # update status
                seafoam.status = STARTED
                win.callOnFlip(seafoam.buttonClock.reset)
                seafoam.setAutoDraw(True)
            
            # if seafoam is active this frame...
            if seafoam.status == STARTED:
                # update params
                pass
                # check whether seafoam has been pressed
                if seafoam.isClicked:
                    if not seafoam.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        seafoam.timesOn.append(routineTimer.getTime())
                        seafoam.timesOff.append(routineTimer.getTime())
                    elif len(seafoam.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        seafoam.timesOff[-1] = routineTimer.getTime()
                    if not seafoam.wasClicked:
                        # end routine when seafoam is clicked
                        continueRoutine = False
                    if not seafoam.wasClicked:
                        # run callback code when seafoam is clicked
                        answer = "Seafoam"
                        colorList.append(answer)
            # take note of whether seafoam was clicked, so that next frame we know if clicks are new
            seafoam.wasClicked = seafoam.isClicked and seafoam.status == STARTED
            # *pink* updates
            
            # if pink is starting this frame...
            if pink.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                pink.frameNStart = frameN  # exact frame index
                pink.tStart = t  # local t and not account for scr refresh
                pink.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pink, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'pink.started')
                # update status
                pink.status = STARTED
                win.callOnFlip(pink.buttonClock.reset)
                pink.setAutoDraw(True)
            
            # if pink is active this frame...
            if pink.status == STARTED:
                # update params
                pass
                # check whether pink has been pressed
                if pink.isClicked:
                    if not pink.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        pink.timesOn.append(routineTimer.getTime())
                        pink.timesOff.append(routineTimer.getTime())
                    elif len(pink.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        pink.timesOff[-1] = routineTimer.getTime()
                    if not pink.wasClicked:
                        # end routine when pink is clicked
                        continueRoutine = False
                    if not pink.wasClicked:
                        # run callback code when pink is clicked
                        answer = "Pink"
                        colorList.append(answer)
            # take note of whether pink was clicked, so that next frame we know if clicks are new
            pink.wasClicked = pink.isClicked and pink.status == STARTED
            # *lime_green* updates
            
            # if lime_green is starting this frame...
            if lime_green.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                lime_green.frameNStart = frameN  # exact frame index
                lime_green.tStart = t  # local t and not account for scr refresh
                lime_green.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(lime_green, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'lime_green.started')
                # update status
                lime_green.status = STARTED
                win.callOnFlip(lime_green.buttonClock.reset)
                lime_green.setAutoDraw(True)
            
            # if lime_green is active this frame...
            if lime_green.status == STARTED:
                # update params
                pass
                # check whether lime_green has been pressed
                if lime_green.isClicked:
                    if not lime_green.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        lime_green.timesOn.append(routineTimer.getTime())
                        lime_green.timesOff.append(routineTimer.getTime())
                    elif len(lime_green.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        lime_green.timesOff[-1] = routineTimer.getTime()
                    if not lime_green.wasClicked:
                        # end routine when lime_green is clicked
                        continueRoutine = False
                    if not lime_green.wasClicked:
                        # run callback code when lime_green is clicked
                        answer = "Lime-green"
                        colorList.append(answer)
            # take note of whether lime_green was clicked, so that next frame we know if clicks are new
            lime_green.wasClicked = lime_green.isClicked and lime_green.status == STARTED
            # *orange* updates
            
            # if orange is starting this frame...
            if orange.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'orange.started')
                # update status
                orange.status = STARTED
                win.callOnFlip(orange.buttonClock.reset)
                orange.setAutoDraw(True)
            
            # if orange is active this frame...
            if orange.status == STARTED:
                # update params
                pass
                # check whether orange has been pressed
                if orange.isClicked:
                    if not orange.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        orange.timesOn.append(routineTimer.getTime())
                        orange.timesOff.append(routineTimer.getTime())
                    elif len(orange.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        orange.timesOff[-1] = routineTimer.getTime()
                    if not orange.wasClicked:
                        # end routine when orange is clicked
                        continueRoutine = False
                    if not orange.wasClicked:
                        # run callback code when orange is clicked
                        answer = "Orange"
                        colorList.append(answer)
            # take note of whether orange was clicked, so that next frame we know if clicks are new
            orange.wasClicked = orange.isClicked and orange.status == STARTED
            # *blue* updates
            ...
            if R.status == NOT_STARTED and tThisFlip >= 0.2-frameTolerance:
                # keep track of start time/frame for later
            ...
            if R.status == STARTED:
                # update params
                R.setText(Rvar1, log=False)
            
            # *G* updates
            
            # if G is starting this frame...
            if G.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if B.status == STARTED:
                # update params
                B.setText(Bvar1, log=False)
            
            # *counter_Text* updates
            
            # if counter_Text is starting this frame...
            if counter_Text.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                counter_Text.frameNStart = frameN  # exact frame index
                counter_Text.tStart = t  # local t and not account for scr refresh
                counter_Text.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(counter_Text, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'counter_Text.started')
                # update status
                counter_Text.status = STARTED
                counter_Text.setAutoDraw(True)
            
            # if counter_Text is active this frame...
            if counter_Text.status == STARTED:
                # update params
                pass
            
            # *total_count* updates
            
            # if total_count is starting this frame...
            if total_count.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                total_count.frameNStart = frameN  # exact frame index
                total_count.tStart = t  # local t and not account for scr refresh
                total_count.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(total_count, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'total_count.started')
                # update status
                total_count.status = STARTED
                total_count.setAutoDraw(True)
            
            # if total_count is active this frame...
            if total_count.status == STARTED:
                # update params
                pass
        ...
        trials.addData('brown.numClicks', brown.numClicks)
        if brown.numClicks:
           trials.addData('brown.timesOn', brown.timesOn[0])
           trials.addData('brown.timesOff', brown.timesOff[0])
        else:
           trials.addData('brown.timesOn', "")
           trials.addData('brown.timesOff', "")
        trials.addData('teal.numClicks', teal.numClicks)
        if teal.numClicks:
           trials.addData('teal.timesOn', teal.timesOn[0])
           trials.addData('teal.timesOff', teal.timesOff[0])
        else:
           trials.addData('teal.timesOn', "")
           trials.addData('teal.timesOff', "")
        trials.addData('bordeaux.numClicks', bordeaux.numClicks)
        if bordeaux.numClicks:
           trials.addData('bordeaux.timesOn', bordeaux.timesOn[0])
           trials.addData('bordeaux.timesOff', bordeaux.timesOff[0])
        else:
           trials.addData('bordeaux.timesOn', "")
           trials.addData('bordeaux.timesOff', "")
        trials.addData('grey.numClicks', grey.numClicks)
        if grey.numClicks:
           trials.addData('grey.timesOn', grey.timesOn[0])
           trials.addData('grey.timesOff', grey.timesOff[0])
        else:
           trials.addData('grey.timesOn', "")
           trials.addData('grey.timesOff', "")
        trials.addData('seafoam.numClicks', seafoam.numClicks)
        if seafoam.numClicks:
           trials.addData('seafoam.timesOn', seafoam.timesOn[0])
           trials.addData('seafoam.timesOff', seafoam.timesOff[0])
        else:
           trials.addData('seafoam.timesOn', "")
           trials.addData('seafoam.timesOff', "")
        trials.addData('pink.numClicks', pink.numClicks)
        if pink.numClicks:
           trials.addData('pink.timesOn', pink.timesOn[0])
           trials.addData('pink.timesOff', pink.timesOff[0])
        else:
           trials.addData('pink.timesOn', "")
           trials.addData('pink.timesOff', "")
        trials.addData('lime_green.numClicks', lime_green.numClicks)
        if lime_green.numClicks:
           trials.addData('lime_green.timesOn', lime_green.timesOn[0])
           trials.addData('lime_green.timesOff', lime_green.timesOff[0])
        else:
           trials.addData('lime_green.timesOn', "")
           trials.addData('lime_green.timesOff', "")
        trials.addData('orange.numClicks', orange.numClicks)
        if orange.numClicks:
           trials.addData('orange.timesOn', orange.timesOn[0])
           trials.addData('orange.timesOff', orange.timesOff[0])
        else:
           trials.addData('orange.timesOn', "")
           trials.addData('orange.timesOff', "")
        ...
        confidence = data.Routine(
            name='confidence',
            components=[slider, text_9, mouse_2, button2, text_answer, brown_3, teal_3, bordeaux_3, grey_3, seafoam_3, pink_3, lime_green_3, orange_3, blue_3, yellow_3, purple_3, cyan_3, red_3, green_3],
        )
        ...
        button2.reset()
        brown_3.setText('Brown')
        # reset brown_3 to account for continued clicks & clear times on/off
        brown_3.reset()
        teal_3.setText('Teal')
        # reset teal_3 to account for continued clicks & clear times on/off
        teal_3.reset()
        bordeaux_3.setText('Bordeaux')
        # reset bordeaux_3 to account for continued clicks & clear times on/off
        bordeaux_3.reset()
        grey_3.setText('Grey')
        # reset grey_3 to account for continued clicks & clear times on/off
        grey_3.reset()
        seafoam_3.setText('Seafoam')
        # reset seafoam_3 to account for continued clicks & clear times on/off
        seafoam_3.reset()
        pink_3.setText('Pink')
        # reset pink_3 to account for continued clicks & clear times on/off
        pink_3.reset()
        lime_green_3.setText('Lime-green')
        # reset lime_green_3 to account for continued clicks & clear times on/off
        lime_green_3.reset()
        orange_3.setText('Orange')
        # reset orange_3 to account for continued clicks & clear times on/off
        orange_3.reset()
        blue_3.setText('Blue')
        ...
        while continueRoutine:
            ...
            # if brown_3 is starting this frame...
            if brown_3.status == NOT_STARTED and answer == "Brown":
                # keep track of start time/frame for later
                brown_3.frameNStart = frameN  # exact frame index
                brown_3.tStart = t  # local t and not account for scr refresh
                brown_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(brown_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'brown_3.started')
                # update status
                brown_3.status = STARTED
                win.callOnFlip(brown_3.buttonClock.reset)
                brown_3.setAutoDraw(True)
            
            # if brown_3 is active this frame...
            if brown_3.status == STARTED:
                # update params
                pass
                # check whether brown_3 has been pressed
                if brown_3.isClicked:
                    if not brown_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        brown_3.timesOn.append(routineTimer.getTime())
                        brown_3.timesOff.append(routineTimer.getTime())
                    elif len(brown_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        brown_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when brown_3 is clicked
                    pass
            # take note of whether brown_3 was clicked, so that next frame we know if clicks are new
            brown_3.wasClicked = brown_3.isClicked and brown_3.status == STARTED
            # *teal_3* updates
            
            # if teal_3 is starting this frame...
            if teal_3.status == NOT_STARTED and answer == "Teal":
                # keep track of start time/frame for later
                teal_3.frameNStart = frameN  # exact frame index
                teal_3.tStart = t  # local t and not account for scr refresh
                teal_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(teal_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'teal_3.started')
                # update status
                teal_3.status = STARTED
                win.callOnFlip(teal_3.buttonClock.reset)
                teal_3.setAutoDraw(True)
            
            # if teal_3 is active this frame...
            if teal_3.status == STARTED:
                # update params
                pass
                # check whether teal_3 has been pressed
                if teal_3.isClicked:
                    if not teal_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        teal_3.timesOn.append(routineTimer.getTime())
                        teal_3.timesOff.append(routineTimer.getTime())
                    elif len(teal_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        teal_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when teal_3 is clicked
                    pass
            # take note of whether teal_3 was clicked, so that next frame we know if clicks are new
            teal_3.wasClicked = teal_3.isClicked and teal_3.status == STARTED
            # *bordeaux_3* updates
            
            # if bordeaux_3 is starting this frame...
            if bordeaux_3.status == NOT_STARTED and answer == "Bordeaux":
                # keep track of start time/frame for later
                bordeaux_3.frameNStart = frameN  # exact frame index
                bordeaux_3.tStart = t  # local t and not account for scr refresh
                bordeaux_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(bordeaux_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'bordeaux_3.started')
                # update status
                bordeaux_3.status = STARTED
                win.callOnFlip(bordeaux_3.buttonClock.reset)
                bordeaux_3.setAutoDraw(True)
            
            # if bordeaux_3 is active this frame...
            if bordeaux_3.status == STARTED:
                # update params
                pass
                # check whether bordeaux_3 has been pressed
                if bordeaux_3.isClicked:
                    if not bordeaux_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        bordeaux_3.timesOn.append(routineTimer.getTime())
                        bordeaux_3.timesOff.append(routineTimer.getTime())
                    elif len(bordeaux_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        bordeaux_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when bordeaux_3 is clicked
                    pass
            # take note of whether bordeaux_3 was clicked, so that next frame we know if clicks are new
            bordeaux_3.wasClicked = bordeaux_3.isClicked and bordeaux_3.status == STARTED
            # *grey_3* updates
            
            # if grey_3 is starting this frame...
            if grey_3.status == NOT_STARTED and answer == "Grey":
                # keep track of start time/frame for later
                grey_3.frameNStart = frameN  # exact frame index
                grey_3.tStart = t  # local t and not account for scr refresh
                grey_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(grey_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'grey_3.started')
                # update status
                grey_3.status = STARTED
                win.callOnFlip(grey_3.buttonClock.reset)
                grey_3.setAutoDraw(True)
            
            # if grey_3 is active this frame...
            if grey_3.status == STARTED:
                # update params
                pass
                # check whether grey_3 has been pressed
                if grey_3.isClicked:
                    if not grey_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        grey_3.timesOn.append(routineTimer.getTime())
                        grey_3.timesOff.append(routineTimer.getTime())
                    elif len(grey_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        grey_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when grey_3 is clicked
                    pass
            # take note of whether grey_3 was clicked, so that next frame we know if clicks are new
            grey_3.wasClicked = grey_3.isClicked and grey_3.status == STARTED
            # *seafoam_3* updates
            
            # if seafoam_3 is starting this frame...
            if seafoam_3.status == NOT_STARTED and answer == "Seafoam":
                # keep track of start time/frame for later
                seafoam_3.frameNStart = frameN  # exact frame index
                seafoam_3.tStart = t  # local t and not account for scr refresh
                seafoam_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(seafoam_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'seafoam_3.started')
                # update status
                seafoam_3.status = STARTED
                win.callOnFlip(seafoam_3.buttonClock.reset)
                seafoam_3.setAutoDraw(True)
            
            # if seafoam_3 is active this frame...
            if seafoam_3.status == STARTED:
                # update params
                pass
                # check whether seafoam_3 has been pressed
                if seafoam_3.isClicked:
                    if not seafoam_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        seafoam_3.timesOn.append(routineTimer.getTime())
                        seafoam_3.timesOff.append(routineTimer.getTime())
                    elif len(seafoam_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        seafoam_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when seafoam_3 is clicked
                    pass
            # take note of whether seafoam_3 was clicked, so that next frame we know if clicks are new
            seafoam_3.wasClicked = seafoam_3.isClicked and seafoam_3.status == STARTED
            # *pink_3* updates
            
            # if pink_3 is starting this frame...
            if pink_3.status == NOT_STARTED and answer == "Pink":
                # keep track of start time/frame for later
                pink_3.frameNStart = frameN  # exact frame index
                pink_3.tStart = t  # local t and not account for scr refresh
                pink_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pink_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'pink_3.started')
                # update status
                pink_3.status = STARTED
                win.callOnFlip(pink_3.buttonClock.reset)
                pink_3.setAutoDraw(True)
            
            # if pink_3 is active this frame...
            if pink_3.status == STARTED:
                # update params
                pass
                # check whether pink_3 has been pressed
                if pink_3.isClicked:
                    if not pink_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        pink_3.timesOn.append(routineTimer.getTime())
                        pink_3.timesOff.append(routineTimer.getTime())
                    elif len(pink_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        pink_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when pink_3 is clicked
                    pass
            # take note of whether pink_3 was clicked, so that next frame we know if clicks are new
            pink_3.wasClicked = pink_3.isClicked and pink_3.status == STARTED
            # *lime_green_3* updates
            
            # if lime_green_3 is starting this frame...
            if lime_green_3.status == NOT_STARTED and answer == "Lime-green":
                # keep track of start time/frame for later
                lime_green_3.frameNStart = frameN  # exact frame index
                lime_green_3.tStart = t  # local t and not account for scr refresh
                lime_green_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(lime_green_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'lime_green_3.started')
                # update status
                lime_green_3.status = STARTED
                win.callOnFlip(lime_green_3.buttonClock.reset)
                lime_green_3.setAutoDraw(True)
            
            # if lime_green_3 is active this frame...
            if lime_green_3.status == STARTED:
                # update params
                pass
                # check whether lime_green_3 has been pressed
                if lime_green_3.isClicked:
                    if not lime_green_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        lime_green_3.timesOn.append(routineTimer.getTime())
                        lime_green_3.timesOff.append(routineTimer.getTime())
                    elif len(lime_green_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        lime_green_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when lime_green_3 is clicked
                    pass
            # take note of whether lime_green_3 was clicked, so that next frame we know if clicks are new
            lime_green_3.wasClicked = lime_green_3.isClicked and lime_green_3.status == STARTED
            # *orange_3* updates
            
            # if orange_3 is starting this frame...
            if orange_3.status == NOT_STARTED and answer == "Orange":
                # keep track of start time/frame for later
                orange_3.frameNStart = frameN  # exact frame index
                orange_3.tStart = t  # local t and not account for scr refresh
                orange_3.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(orange_3, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'orange_3.started')
                # update status
                orange_3.status = STARTED
                win.callOnFlip(orange_3.buttonClock.reset)
                orange_3.setAutoDraw(True)
            
            # if orange_3 is active this frame...
            if orange_3.status == STARTED:
                # update params
                pass
                # check whether orange_3 has been pressed
                if orange_3.isClicked:
                    if not orange_3.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        orange_3.timesOn.append(routineTimer.getTime())
                        orange_3.timesOff.append(routineTimer.getTime())
                    elif len(orange_3.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        orange_3.timesOff[-1] = routineTimer.getTime()
                    # run callback code when orange_3 is clicked
                    pass
            # take note of whether orange_3 was clicked, so that next frame we know if clicks are new
            orange_3.wasClicked = orange_3.isClicked and orange_3.status == STARTED
            # *blue_3* updates
        ...
        trials.addData('brown_3.numClicks', brown_3.numClicks)
        if brown_3.numClicks:
           trials.addData('brown_3.timesOn', brown_3.timesOn)
           trials.addData('brown_3.timesOff', brown_3.timesOff)
        else:
           trials.addData('brown_3.timesOn', "")
           trials.addData('brown_3.timesOff', "")
        trials.addData('teal_3.numClicks', teal_3.numClicks)
        if teal_3.numClicks:
           trials.addData('teal_3.timesOn', teal_3.timesOn)
           trials.addData('teal_3.timesOff', teal_3.timesOff)
        else:
           trials.addData('teal_3.timesOn', "")
           trials.addData('teal_3.timesOff', "")
        trials.addData('bordeaux_3.numClicks', bordeaux_3.numClicks)
        if bordeaux_3.numClicks:
           trials.addData('bordeaux_3.timesOn', bordeaux_3.timesOn)
           trials.addData('bordeaux_3.timesOff', bordeaux_3.timesOff)
        else:
           trials.addData('bordeaux_3.timesOn', "")
           trials.addData('bordeaux_3.timesOff', "")
        trials.addData('grey_3.numClicks', grey_3.numClicks)
        if grey_3.numClicks:
           trials.addData('grey_3.timesOn', grey_3.timesOn)
           trials.addData('grey_3.timesOff', grey_3.timesOff)
        else:
           trials.addData('grey_3.timesOn', "")
           trials.addData('grey_3.timesOff', "")
        trials.addData('seafoam_3.numClicks', seafoam_3.numClicks)
        if seafoam_3.numClicks:
           trials.addData('seafoam_3.timesOn', seafoam_3.timesOn)
           trials.addData('seafoam_3.timesOff', seafoam_3.timesOff)
        else:
           trials.addData('seafoam_3.timesOn', "")
           trials.addData('seafoam_3.timesOff', "")
        trials.addData('pink_3.numClicks', pink_3.numClicks)
        if pink_3.numClicks:
           trials.addData('pink_3.timesOn', pink_3.timesOn)
           trials.addData('pink_3.timesOff', pink_3.timesOff)
        else:
           trials.addData('pink_3.timesOn', "")
           trials.addData('pink_3.timesOff', "")
        trials.addData('lime_green_3.numClicks', lime_green_3.numClicks)
        if lime_green_3.numClicks:
           trials.addData('lime_green_3.timesOn', lime_green_3.timesOn)
           trials.addData('lime_green_3.timesOff', lime_green_3.timesOff)
        else:
           trials.addData('lime_green_3.timesOn', "")
           trials.addData('lime_green_3.timesOff', "")
        trials.addData('orange_3.numClicks', orange_3.numClicks)
        if orange_3.numClicks:
           trials.addData('orange_3.timesOn', orange_3.timesOn)
           trials.addData('orange_3.timesOff', orange_3.timesOff)
        else:
           trials.addData('orange_3.timesOn', "")
           trials.addData('orange_3.timesOff', "")
        ...
        confirm = data.Routine(
            name='confirm',
            components=[Button3, correctAnswer, wrongAnswer, corrColor_2, brown_2, teal_2, bordeaux_2, grey_2, seafoam_2, pink_2, lime_green_2, orange_2, blue_2, yellow_2, purple_2, cyan_2, red_2, green_2, RBGInfo_2, R_2, G_2, B_2, key_resp],
        )
        ...
        brown_2.setText('Brown')
        # reset brown_2 to account for continued clicks & clear times on/off
        brown_2.reset()
        teal_2.setText('Teal')
        # reset teal_2 to account for continued clicks & clear times on/off
        teal_2.reset()
        bordeaux_2.setText('Bordeaux')
        # reset bordeaux_2 to account for continued clicks & clear times on/off
        bordeaux_2.reset()
        grey_2.setText('Grey')
        # reset grey_2 to account for continued clicks & clear times on/off
        grey_2.reset()
        seafoam_2.setText('Seafoam')
        # reset seafoam_2 to account for continued clicks & clear times on/off
        seafoam_2.reset()
        pink_2.setText('Pink')
        # reset pink_2 to account for continued clicks & clear times on/off
        pink_2.reset()
        lime_green_2.setText('Lime-green')
        # reset lime_green_2 to account for continued clicks & clear times on/off
        lime_green_2.reset()
        orange_2.setText('Orange')
        # reset orange_2 to account for continued clicks & clear times on/off
        orange_2.reset()
        blue_2.setText('Blue')
        ...
        while continueRoutine:
            ...
            # if brown_2 is starting this frame...
            if brown_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                brown_2.frameNStart = frameN  # exact frame index
                brown_2.tStart = t  # local t and not account for scr refresh
                brown_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(brown_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'brown_2.started')
                # update status
                brown_2.status = STARTED
                win.callOnFlip(brown_2.buttonClock.reset)
                brown_2.setAutoDraw(True)
            
            # if brown_2 is active this frame...
            if brown_2.status == STARTED:
                # update params
                pass
                # check whether brown_2 has been pressed
                if brown_2.isClicked:
                    if not brown_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        brown_2.timesOn.append(routineTimer.getTime())
                        brown_2.timesOff.append(routineTimer.getTime())
                    elif len(brown_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        brown_2.timesOff[-1] = routineTimer.getTime()
                    if not brown_2.wasClicked:
                        # run callback code when brown_2 is clicked
                        answer = "Brown"
                        colorList.append(answer)
            # take note of whether brown_2 was clicked, so that next frame we know if clicks are new
            brown_2.wasClicked = brown_2.isClicked and brown_2.status == STARTED
            
            # if brown_2 is stopping this frame...
            if brown_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    brown_2.tStop = t  # not accounting for scr refresh
                    brown_2.tStopRefresh = tThisFlipGlobal  # on global time
                    brown_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'brown_2.stopped')
                    # update status
                    brown_2.status = FINISHED
                    brown_2.setAutoDraw(False)
            # *teal_2* updates
            
            # if teal_2 is starting this frame...
            if teal_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                teal_2.frameNStart = frameN  # exact frame index
                teal_2.tStart = t  # local t and not account for scr refresh
                teal_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(teal_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'teal_2.started')
                # update status
                teal_2.status = STARTED
                win.callOnFlip(teal_2.buttonClock.reset)
                teal_2.setAutoDraw(True)
            
            # if teal_2 is active this frame...
            if teal_2.status == STARTED:
                # update params
                pass
                # check whether teal_2 has been pressed
                if teal_2.isClicked:
                    if not teal_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        teal_2.timesOn.append(routineTimer.getTime())
                        teal_2.timesOff.append(routineTimer.getTime())
                    elif len(teal_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        teal_2.timesOff[-1] = routineTimer.getTime()
                    if not teal_2.wasClicked:
                        # run callback code when teal_2 is clicked
                        answer = "Teal"
                        colorList.append(answer)
            # take note of whether teal_2 was clicked, so that next frame we know if clicks are new
            teal_2.wasClicked = teal_2.isClicked and teal_2.status == STARTED
            
            # if teal_2 is stopping this frame...
            if teal_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    teal_2.tStop = t  # not accounting for scr refresh
                    teal_2.tStopRefresh = tThisFlipGlobal  # on global time
                    teal_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'teal_2.stopped')
                    # update status
                    teal_2.status = FINISHED
                    teal_2.setAutoDraw(False)
            # *bordeaux_2* updates
            
            # if bordeaux_2 is starting this frame...
            if bordeaux_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                bordeaux_2.frameNStart = frameN  # exact frame index
                bordeaux_2.tStart = t  # local t and not account for scr refresh
                bordeaux_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(bordeaux_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'bordeaux_2.started')
                # update status
                bordeaux_2.status = STARTED
                win.callOnFlip(bordeaux_2.buttonClock.reset)
                bordeaux_2.setAutoDraw(True)
            
            # if bordeaux_2 is active this frame...
            if bordeaux_2.status == STARTED:
                # update params
                pass
                # check whether bordeaux_2 has been pressed
                if bordeaux_2.isClicked:
                    if not bordeaux_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        bordeaux_2.timesOn.append(routineTimer.getTime())
                        bordeaux_2.timesOff.append(routineTimer.getTime())
                    elif len(bordeaux_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        bordeaux_2.timesOff[-1] = routineTimer.getTime()
                    if not bordeaux_2.wasClicked:
                        # run callback code when bordeaux_2 is clicked
                        answer = "Bordeaux"
                        colorList.append(answer)
            # take note of whether bordeaux_2 was clicked, so that next frame we know if clicks are new
            bordeaux_2.wasClicked = bordeaux_2.isClicked and bordeaux_2.status == STARTED
            
            # if bordeaux_2 is stopping this frame...
            if bordeaux_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    bordeaux_2.tStop = t  # not accounting for scr refresh
                    bordeaux_2.tStopRefresh = tThisFlipGlobal  # on global time
                    bordeaux_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'bordeaux_2.stopped')
                    # update status
                    bordeaux_2.status = FINISHED
                    bordeaux_2.setAutoDraw(False)
            # *grey_2* updates
            
            # if grey_2 is starting this frame...
            if grey_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                grey_2.frameNStart = frameN  # exact frame index
                grey_2.tStart = t  # local t and not account for scr refresh
                grey_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(grey_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'grey_2.started')
                # update status
                grey_2.status = STARTED
                win.callOnFlip(grey_2.buttonClock.reset)
                grey_2.setAutoDraw(True)
            
            # if grey_2 is active this frame...
            if grey_2.status == STARTED:
                # update params
                pass
                # check whether grey_2 has been pressed
                if grey_2.isClicked:
                    if not grey_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        grey_2.timesOn.append(routineTimer.getTime())
                        grey_2.timesOff.append(routineTimer.getTime())
                    elif len(grey_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        grey_2.timesOff[-1] = routineTimer.getTime()
                    if not grey_2.wasClicked:
                        # run callback code when grey_2 is clicked
                        answer = "Grey"
                        colorList.append(answer)
            # take note of whether grey_2 was clicked, so that next frame we know if clicks are new
            grey_2.wasClicked = grey_2.isClicked and grey_2.status == STARTED
            
            # if grey_2 is stopping this frame...
            if grey_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    grey_2.tStop = t  # not accounting for scr refresh
                    grey_2.tStopRefresh = tThisFlipGlobal  # on global time
                    grey_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'grey_2.stopped')
                    # update status
                    grey_2.status = FINISHED
                    grey_2.setAutoDraw(False)
            # *seafoam_2* updates
            
            # if seafoam_2 is starting this frame...
            if seafoam_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                seafoam_2.frameNStart = frameN  # exact frame index
                seafoam_2.tStart = t  # local t and not account for scr refresh
                seafoam_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(seafoam_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'seafoam_2.started')
                # update status
                seafoam_2.status = STARTED
                win.callOnFlip(seafoam_2.buttonClock.reset)
                seafoam_2.setAutoDraw(True)
            
            # if seafoam_2 is active this frame...
            if seafoam_2.status == STARTED:
                # update params
                pass
                # check whether seafoam_2 has been pressed
                if seafoam_2.isClicked:
                    if not seafoam_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        seafoam_2.timesOn.append(routineTimer.getTime())
                        seafoam_2.timesOff.append(routineTimer.getTime())
                    elif len(seafoam_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        seafoam_2.timesOff[-1] = routineTimer.getTime()
                    if not seafoam_2.wasClicked:
                        # run callback code when seafoam_2 is clicked
                        answer = "Seafoam"
                        colorList.append(answer)
            # take note of whether seafoam_2 was clicked, so that next frame we know if clicks are new
            seafoam_2.wasClicked = seafoam_2.isClicked and seafoam_2.status == STARTED
            
            # if seafoam_2 is stopping this frame...
            if seafoam_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    seafoam_2.tStop = t  # not accounting for scr refresh
                    seafoam_2.tStopRefresh = tThisFlipGlobal  # on global time
                    seafoam_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'seafoam_2.stopped')
                    # update status
                    seafoam_2.status = FINISHED
                    seafoam_2.setAutoDraw(False)
            # *pink_2* updates
            
            # if pink_2 is starting this frame...
            if pink_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                pink_2.frameNStart = frameN  # exact frame index
                pink_2.tStart = t  # local t and not account for scr refresh
                pink_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pink_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'pink_2.started')
                # update status
                pink_2.status = STARTED
                win.callOnFlip(pink_2.buttonClock.reset)
                pink_2.setAutoDraw(True)
            
            # if pink_2 is active this frame...
            if pink_2.status == STARTED:
                # update params
                pass
                # check whether pink_2 has been pressed
                if pink_2.isClicked:
                    if not pink_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        pink_2.timesOn.append(routineTimer.getTime())
                        pink_2.timesOff.append(routineTimer.getTime())
                    elif len(pink_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        pink_2.timesOff[-1] = routineTimer.getTime()
                    if not pink_2.wasClicked:
                        # run callback code when pink_2 is clicked
                        answer = "Pink"
                        colorList.append(answer)
            # take note of whether pink_2 was clicked, so that next frame we know if clicks are new
            pink_2.wasClicked = pink_2.isClicked and pink_2.status == STARTED
            
            # if pink_2 is stopping this frame...
            if pink_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    pink_2.tStop = t  # not accounting for scr refresh
                    pink_2.tStopRefresh = tThisFlipGlobal  # on global time
                    pink_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'pink_2.stopped')
                    # update status
                    pink_2.status = FINISHED
                    pink_2.setAutoDraw(False)
            # *lime_green_2* updates
            
            # if lime_green_2 is starting this frame...
            if lime_green_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                lime_green_2.frameNStart = frameN  # exact frame index
                lime_green_2.tStart = t  # local t and not account for scr refresh
                lime_green_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(lime_green_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'lime_green_2.started')
                # update status
                lime_green_2.status = STARTED
                win.callOnFlip(lime_green_2.buttonClock.reset)
                lime_green_2.setAutoDraw(True)
            
            # if lime_green_2 is active this frame...
            if lime_green_2.status == STARTED:
                # update params
                pass
                # check whether lime_green_2 has been pressed
                if lime_green_2.isClicked:
                    if not lime_green_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        lime_green_2.timesOn.append(routineTimer.getTime())
                        lime_green_2.timesOff.append(routineTimer.getTime())
                    elif len(lime_green_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        lime_green_2.timesOff[-1] = routineTimer.getTime()
                    if not lime_green_2.wasClicked:
                        # run callback code when lime_green_2 is clicked
                        answer = "Lime-green"
                        colorList.append(answer)
            # take note of whether lime_green_2 was clicked, so that next frame we know if clicks are new
            lime_green_2.wasClicked = lime_green_2.isClicked and lime_green_2.status == STARTED
            
            # if lime_green_2 is stopping this frame...
            if lime_green_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    lime_green_2.tStop = t  # not accounting for scr refresh
                    lime_green_2.tStopRefresh = tThisFlipGlobal  # on global time
                    lime_green_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'lime_green_2.stopped')
                    # update status
                    lime_green_2.status = FINISHED
                    lime_green_2.setAutoDraw(False)
            # *orange_2* updates
            
            # if orange_2 is starting this frame...
            if orange_2.status == NOT_STARTED and answer != corrColor:
                # keep track of start time/frame for later
                orange_2.frameNStart = frameN  # exact frame index
                orange_2.tStart = t  # local t and not account for scr refresh
                orange_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(orange_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'orange_2.started')
                # update status
                orange_2.status = STARTED
                win.callOnFlip(orange_2.buttonClock.reset)
                orange_2.setAutoDraw(True)
            
            # if orange_2 is active this frame...
            if orange_2.status == STARTED:
                # update params
                pass
                # check whether orange_2 has been pressed
                if orange_2.isClicked:
                    if not orange_2.wasClicked:
                        # if this is a new click, store time of first click and clicked until
                        orange_2.timesOn.append(routineTimer.getTime())
                        orange_2.timesOff.append(routineTimer.getTime())
                    elif len(orange_2.timesOff):
                        # if click is continuing from last frame, update time of clicked until
                        orange_2.timesOff[-1] = routineTimer.getTime()
                    if not orange_2.wasClicked:
                        # run callback code when orange_2 is clicked
                        answer = "Orange"
                        colorList.append(answer)
            # take note of whether orange_2 was clicked, so that next frame we know if clicks are new
            orange_2.wasClicked = orange_2.isClicked and orange_2.status == STARTED
            
            # if orange_2 is stopping this frame...
            if orange_2.status == STARTED:
                if bool(answer == corrColor):
                    # keep track of stop time/frame for later
                    orange_2.tStop = t  # not accounting for scr refresh
                    orange_2.tStopRefresh = tThisFlipGlobal  # on global time
                    orange_2.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'orange_2.stopped')
                    # update status
                    orange_2.status = FINISHED
                    orange_2.setAutoDraw(False)
            # *blue_2* updates
        ...
        trials.addData('brown_2.numClicks', brown_2.numClicks)
        if brown_2.numClicks:
           trials.addData('brown_2.timesOn', brown_2.timesOn)
           trials.addData('brown_2.timesOff', brown_2.timesOff)
        else:
           trials.addData('brown_2.timesOn', "")
           trials.addData('brown_2.timesOff', "")
        trials.addData('teal_2.numClicks', teal_2.numClicks)
        if teal_2.numClicks:
           trials.addData('teal_2.timesOn', teal_2.timesOn)
           trials.addData('teal_2.timesOff', teal_2.timesOff)
        else:
           trials.addData('teal_2.timesOn', "")
           trials.addData('teal_2.timesOff', "")
        trials.addData('bordeaux_2.numClicks', bordeaux_2.numClicks)
        if bordeaux_2.numClicks:
           trials.addData('bordeaux_2.timesOn', bordeaux_2.timesOn)
           trials.addData('bordeaux_2.timesOff', bordeaux_2.timesOff)
        else:
           trials.addData('bordeaux_2.timesOn', "")
           trials.addData('bordeaux_2.timesOff', "")
        trials.addData('grey_2.numClicks', grey_2.numClicks)
        if grey_2.numClicks:
           trials.addData('grey_2.timesOn', grey_2.timesOn)
           trials.addData('grey_2.timesOff', grey_2.timesOff)
        else:
           trials.addData('grey_2.timesOn', "")
           trials.addData('grey_2.timesOff', "")
        trials.addData('seafoam_2.numClicks', seafoam_2.numClicks)
        if seafoam_2.numClicks:
           trials.addData('seafoam_2.timesOn', seafoam_2.timesOn)
           trials.addData('seafoam_2.timesOff', seafoam_2.timesOff)
        else:
           trials.addData('seafoam_2.timesOn', "")
           trials.addData('seafoam_2.timesOff', "")
        trials.addData('pink_2.numClicks', pink_2.numClicks)
        if pink_2.numClicks:
           trials.addData('pink_2.timesOn', pink_2.timesOn)
           trials.addData('pink_2.timesOff', pink_2.timesOff)
        else:
           trials.addData('pink_2.timesOn', "")
           trials.addData('pink_2.timesOff', "")
        trials.addData('lime_green_2.numClicks', lime_green_2.numClicks)
        if lime_green_2.numClicks:
           trials.addData('lime_green_2.timesOn', lime_green_2.timesOn)
           trials.addData('lime_green_2.timesOff', lime_green_2.timesOff)
        else:
           trials.addData('lime_green_2.timesOn', "")
           trials.addData('lime_green_2.timesOff', "")
        trials.addData('orange_2.numClicks', orange_2.numClicks)
        if orange_2.numClicks:
           trials.addData('orange_2.timesOn', orange_2.timesOn)
           trials.addData('orange_2.timesOff', orange_2.timesOff)
        else:
           trials.addData('orange_2.timesOn', "")
           trials.addData('orange_2.timesOff', "")
