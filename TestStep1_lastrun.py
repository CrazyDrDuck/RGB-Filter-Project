...
expName = 'TestStep1'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\lille\\NewOneDrive\\OneDrive\\Emilie\\MasterThesisProject\\TestStep1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('ExcelOutputTestStep1.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        initiate.skipped = continueRoutine and not (trial_counter >= 26)
        ...
        trial_1.skipped = continueRoutine and not (trial_counter >= 26)
        ...
        Pause350.skipped = continueRoutine and not (trial_counter >= 26)
        ...
        confidence.skipped = continueRoutine and not (trial_counter >= 26)
        ...
        confirm = data.Routine(
            name='confirm',
            components=[Button3, correctAnswer, wrongAnswer, corrColor_2, blue_2, yellow_2, purple_2, cyan_2, red_2, green_2, RBGInfo_2, R_2, G_2, B_2, key_resp],
        )
        ...
        confirm.skipped = continueRoutine and not (trial_counter >= 26)
        ...
        PauseEnd.skipped = continueRoutine and not (trial_counter >= 26)
