...
expName = 'ExpDemo2'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\lille\\NewOneDrive\\OneDrive\\Emilie\\MasterThesisProject\\ExpDemo2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        trial_1 = data.Routine(
            name='trial_1',
            components=[img, spacebar, seafoam, pink, lime_green, orange, blue, yellow, purple, cyan, red, green, Instructions, RBGInfo, R, G, B],
        )
